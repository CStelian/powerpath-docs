...
import { season, botVersion } from '../../data/data'
...
<Aside type="caution" title="Note!">
    The bot is currently in Pre-Season Beta. Bugs may occur, and the bot may not be fully functional. Please report any issues to our Support server.
</Aside>

To use the bot, you need to have the bot in your server. You can add the bot by joining our <a href="https://discord.gg/HCGcDCtmSh" target="_blank">Discord server</a>.

## Current Season

The current season is **{season}**. The current version is **{botVersion}**.
